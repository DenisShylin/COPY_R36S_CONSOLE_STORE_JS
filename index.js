(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))l(i);new MutationObserver(i=>{for(const r of i)if(r.type==="childList")for(const c of r.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&l(c)}).observe(document,{childList:!0,subtree:!0});function e(i){const r={};return i.integrity&&(r.integrity=i.integrity),i.referrerPolicy&&(r.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?r.credentials="include":i.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function l(i){if(i.ep)return;i.ep=!0;const r=e(i);fetch(i.href,r)}})();function H(){let t=!1,n=window.scrollY,e=null;const l=document.querySelector(".header"),i=document.querySelector(".burger-btn"),r=document.querySelector(".burger-line"),c=document.querySelector(".mobile-menu"),m=document.querySelectorAll(".our-menu-link, .mobile-menu__link");function u(){const a=window.scrollY,s=n<a;e&&clearTimeout(e),a>100?b(!s):b(!0),n=a,v(a>0),e=setTimeout(()=>{},150)}function g(){t=!t,w()}function w(){t?(l.classList.add("menu-open"),i.setAttribute("aria-expanded","true"),r.classList.add("open"),c.classList.add("open"),document.body.style.overflow="hidden"):(l.classList.remove("menu-open"),i.setAttribute("aria-expanded","false"),r.classList.remove("open"),c.classList.remove("open"),document.body.style.overflow="unset")}function v(a){a?l.classList.add("scrolled"):l.classList.remove("scrolled")}function b(a){a?(l.classList.add("visible"),l.classList.remove("hidden")):(l.classList.add("hidden"),l.classList.remove("visible"))}function y(a){a.preventDefault();const s=a.currentTarget.getAttribute("href"),f=s.replace("#",""),o=document.getElementById(f);o&&(b(!0),setTimeout(()=>{l.offsetHeight;const h=o.getBoundingClientRect().top+window.scrollY;window.scrollTo({top:h,behavior:"smooth"}),t&&(t=!1,w()),window.history.replaceState(null,"",`${window.location.pathname}${s}`),setTimeout(()=>{n=window.scrollY},100)},50))}function p(){if(window.location.hash){const a=window.location.hash.replace("#",""),s=document.getElementById(a);s&&setTimeout(()=>{const f=l.offsetHeight,d=s.getBoundingClientRect().top+window.scrollY-f;window.scrollTo({top:d,behavior:"smooth"})},100)}}window.addEventListener("scroll",u),window.addEventListener("resize",()=>{!(window.innerWidth<=768)&&t&&(t=!1,w())}),i&&i.addEventListener("click",g),m.forEach(a=>{a.addEventListener("click",y)}),p()}function G(){const t=document.querySelector(".mobile-menu");if(!t){console.error("Мобильное меню не найдено в DOM");return}const n=t.querySelector(".close-button");if(!n){console.error("Кнопка закрытия не найдена в мобильном меню");return}n.addEventListener("click",()=>{e()});function e(){t.classList.remove("open");const c=document.querySelector(".burger-line");c&&c.classList.remove("open"),document.body.style.overflow="unset";const m=document.querySelector(".header");m&&m.classList.remove("menu-open");const u=document.querySelector(".burger-btn");u&&u.setAttribute("aria-expanded","false")}t.querySelectorAll(".mobile-menu__link").forEach(c=>{c.addEventListener("click",()=>{setTimeout(()=>{e()},150)})});const i=t.querySelector(".mobile-menu__background");i&&i.addEventListener("click",()=>{e()});function r(){t.querySelectorAll(".mobile-menu__icon").forEach((m,u)=>{m.style.opacity="0",m.style.transform="translateX(-20px)",new MutationObserver(w=>{w.forEach(v=>{v.attributeName==="class"&&(t.classList.contains("open")?setTimeout(()=>{m.style.transition="all 0.4s ease",m.style.opacity="1",m.style.transform="translateX(0)"},100+u*70):(m.style.opacity="0",m.style.transform="translateX(-20px)"))})}).observe(t,{attributes:!0})})}r(),console.log("Мобильное меню с иконками инициализировано")}function z(){const t=document.querySelector(".hero"),n=document.querySelector(".hero__console-img"),e=document.querySelector(".hero__content"),l=document.querySelector(".hero__description--desktop"),i=document.querySelector(".hero__description--mobile");document.querySelector(".hero__pricing");const r=document.getElementById("buy-button"),c=document.getElementById("more-details-button");let m=null,u;function g(){!n||!t||(n.onload=()=>t.classList.add("hero--loaded"),n.onerror=()=>{console.error("Не удалось загрузить изображение:",n.src),t.classList.add("hero--loaded")},n.complete&&t.classList.add("hero--loaded"))}function w(){if(!l||!i)return;const f=window.innerWidth>992;l.style.display=f?"block":"none",i.style.display=f?"none":"block"}function v(){e&&(m&&(m.disconnect(),m=null),m=new IntersectionObserver(f=>{f.forEach(o=>{var d;o.isIntersecting&&((d=o.target)!=null&&d.isConnected)&&(o.target.classList.add("animate-in"),m==null||m.unobserve(o.target))})},{threshold:.1}),e.isConnected&&m.observe(e))}function b(){r&&r.addEventListener("click",y),c&&c.addEventListener("click",p)}function y(){window.open("https://www.aliexpress.com/item/1005007171465465.html","_blank","noopener,noreferrer")}function p(f){f.preventDefault();const o=document.getElementById("features");if(!o){window.location.hash="features";return}const h=o.getBoundingClientRect().top+window.scrollY;window.scrollTo({top:h,behavior:"smooth"}),window.history.replaceState(null,"",`${window.location.pathname}#features`)}function a(){m&&m.disconnect(),clearTimeout(u),window.removeEventListener("resize",s),r&&r.removeEventListener("click",y),c&&c.removeEventListener("click",p)}function s(){clearTimeout(u),u=setTimeout(w,200)}return g(),w(),v(),b(),window.addEventListener("resize",s),a}function W(t){let n=null,e=null,l=!1,i=0,r=null;(()=>{document.getElementById("modal-about-styles")||console.log("Проверка стилей модального окна")})();function m(s){s.key==="Escape"&&l&&p()}function u(){const s=document.createElement("div");return s.className="modal-about-overlay",s.setAttribute("role","dialog"),s.setAttribute("aria-modal","true"),s.setAttribute("tabindex","-1"),s.style.display="none",s.addEventListener("click",p),t.appendChild(s),s}function g(){return e?e.title==="Extensive color selection"&&e.colorImages?`
  ...
  `:""}function w(){(e==null?void 0:e.title)==="Extensive color selection"&&e.colorImages&&(r&&clearInterval(r),r=setInterval(()=>{i=i===e.colorImages.length-1?0:i+1;const s=n.querySelector(".modal-about-image");s&&(s.src=e.colorImages[i],s.alt=`R36S Color Variant ${i+1}`)},1e3))}function v(){if(!n||!e)return;const s={"@context":"https://schema.org","@type":"ItemPage",mainEntity:{"@type":"Product",name:"R36S Handheld Game Console",description:e.fullDescription,image:e.imageUrl||(e.colorImages?e.colorImages[0]:""),offers:{"@type":"Offer",price:"35.48",priceCurrency:"USD",url:"https://www.aliexpress.com/item/1005007171465465.html"},category:"Video Game Console",feature:e.title}};e.id===1&&(s.mainEntity.faqPage={"@type":"FAQPage",mainEntity:[{"@type":"Question",name:"How many games are included in the R36S console?",acceptedAnswer:{"@type":"Answer",text:"The R36S console includes over 15,000 classic retro games from various platforms."}}]});const f=`
      ...
      `;const o=n.querySelector(".modal-about-close");o&&o.addEventListener("click",p);const d=n.querySelector(".modal-about-content");d&&d.addEventListener("click",h=>h.stopPropagation())}function b(s){e=s,n||(n=u()),v();const f=window.location.href,o=new URL(f);return o.searchParams.set("feature",e.id),window.history.pushState({featureId:e.id},"",o),n.style.display="flex",l=!0,n.focus(),window.addEventListener("keydown",m),document.body.style.overflow="hidden",w(),window.addEventListener("popstate",y),{close:p}}function y(s){l&&(!s.state||!s.state.featureId)&&p()}function p(){if(!l||!n)return;l=!1,n.style.display="none",window.removeEventListener("keydown",m),window.removeEventListener("popstate",y),document.body.style.overflow="visible",r&&(clearInterval(r),r=null);const s=new URL(window.location.href);s.searchParams.delete("feature"),window.history.pushState({},"",s)}function a(){p(),n&&t.contains(n)&&t.removeChild(n),n=null,e=null}return{open:b,close:p,destroy:a}}const D="/COPY_R36S_CONSOLE_STORE_JS/video/about/video_1_.webp",P="/COPY_R36S_CONSOLE_STORE_JS/video/about/video_2_.webp",N="/COPY_R36S_CONSOLE_STORE_JS/img/about/Untitled_1_1x.jpg",$="/COPY_R36S_CONSOLE_STORE_JS/img/about/Untitled_2_1x.jpg",U="/COPY_R36S_CONSOLE_STORE_JS/img/about/Untitled_3_1x.jpg",Z="/COPY_R36S_CONSOLE_STORE_JS/img/about/Untitled_4_1x.jpg",F="/COPY_R36S_CONSOLE_STORE_JS/video/about/video_3_batrey_.mp4",V="/COPY_R36S_CONSOLE_STORE_JS/video/about/video_6_.mp4",Y="/COPY_R36S_CONSOLE_STORE_JS/video/about/video_4_.mp4";let A=null;function J(){if(console.log("Начинаем предзагрузку изображений..."),[D,P,N,$].forEach(n=>{const e=new Image;e.src=n}),"HTMLVideoElement"in window){const n=document.createElement("video");n.preload="metadata",n.src=F}console.log("Предзагрузка изображений завершена")}function Q(){console.log("Инициализация секции About"),J();const t=document.querySelector(".about__cards");if(!t)return console.error("Контейнер для карточек не найден"),null;let n={x:0,y:0};A||(console.log("Создаем модальное окно..."),A=W(document.body),console.log("Модальное окно создано"));let e=A;const i=[{id:1,icon:`
        <svg
...
• Quick startup for instant gaming access`,videoUrl:V,imageAlt:"R36S Portability"}];function r(){console.log("Начинаем рендеринг карточек..."),t.innerHTML="";const p=i.map(s=>`
    ...
    `).join("");t.innerHTML=p;const a=t.querySelectorAll(".about-card");console.log(`Отрендерено ${a.length} карточек из ${i.length} необходимых`),a.length!==i.length?console.warn(`Ошибка рендеринга: отрендерено ${a.length} карточек вместо ${i.length}`):console.log("Рендеринг карточек успешно завершен")}const c=m(function(p){if(!p||!p.currentTarget)return;const a=p.currentTarget;if(!a||!a.getBoundingClientRect){console.warn("handleMouseMove: элемент карточки не существует или недоступен");return}try{const s=a.getBoundingClientRect();n={x:p.clientX-s.left,y:p.clientY-s.top},a.style.setProperty("--mouse-x",`${n.x}px`),a.style.setProperty("--mouse-y",`${n.y}px`)}catch(s){console.error("Ошибка при обработке движения мыши:",s)}},16);function m(p,a){let s,f;return function(){const o=this,d=arguments;f?(clearTimeout(s),s=setTimeout(function(){Date.now()-f>=a&&(p.apply(o,d),f=Date.now())},a-(Date.now()-f))):(p.apply(o,d),f=Date.now())}}function u(p){if(!p||!p.currentTarget){console.warn("handleButtonClick: событие или цель события не существует");return}p.stopPropagation();try{const a=parseInt(p.currentTarget.dataset.featureId);console.log("Клик по кнопке карточки ID:",a);const s=i.find(f=>f.id===a);if(!s){console.error("Данные для карточки не найдены");return}e&&e.open(s)}catch(a){console.error("Ошибка при обработке клика по кнопке:",a)}}function g(p,a){let s;return function(){const f=this,o=arguments;clearTimeout(s),s=setTimeout(()=>{p.apply(f,o)},a)}}function w(){console.log("Очистка обработчиков событий карточек...");try{const p=document.querySelectorAll(".about-card");p&&p.length>0&&p.forEach(s=>{s&&(s.removeEventListener("mouseenter",()=>{}),s.removeEventListener("mouseleave",()=>{}),s.removeEventListener("mousemove",c))});const a=document.querySelectorAll(".about-card__button");a&&a.length>0&&a.forEach(s=>{s&&s.removeEventListener("click",u)}),t&&t.removeEventListener("click",()=>{}),console.log("Очистка обработчиков завершена")}catch(p){console.error("Ошибка при очистке обработчиков событий:",p)}}function v(){console.log("Настройка обработчиков событий для карточек...");const p=()=>{console.log("Проверяем наличие карточек для установки обработчиков...");const a=document.querySelectorAll(".about-card");if(!a||a.length===0){console.warn("Не найдены карточки для установки обработчиков событий"),setTimeout(p,200);return}console.log(`Устанавливаем обработчики событий для ${a.length} карточек`);const s=window.matchMedia("(max-width: 768px)").matches;!s&&t&&t.addEventListener("click",function(o){const d=o.target.closest(".about-card");if(d&&!o.target.closest(".about-card__button")){const h=parseInt(d.dataset.id);console.log("Клик по карточке ID:",h);const _=i.find(S=>S.id===h);if(!_){console.error("Данные для карточки не найдены");return}e&&e.open(_)}}),a.forEach(o=>{o&&(o.addEventListener("mouseenter",function(){o&&(parseInt(o.dataset.id),o.classList.add("active"))}),o.addEventListener("mouseleave",function(){o&&o.classList.remove("active")}),o.addEventListener("mousemove",c))});const f=document.querySelectorAll(".about-card__button");f&&f.length>0?(f.forEach(o=>{o&&o.addEventListener("click",u)}),console.log(`Установлены обработчики для ${f.length} кнопок`)):console.warn("Не найдены кнопки карточек"),window.addEventListener("resize",g(()=>{const o=!s,d=!window.matchMedia("(max-width: 768px)").matches;o!==d&&(w(),v())},250)),console.log("Настройка обработчиков событий успешно завершена")};document.readyState==="complete"||document.readyState==="interactive"?setTimeout(p,10):document.addEventListener("DOMContentLoaded",p)}function b(){console.log("Очистка всех обработчиков событий..."),w(),window.removeEventListener("resize",g),e=null,console.log("Очистка обработчиков событий завершена")}function y(){return function(){console.log("Запуск функции очистки секции About"),b()}}try{return console.log("Начинаем инициализацию секции About..."),console.log("Рендерим карточки..."),r(),console.log("Устанавливаем обработчики событий..."),v(),console.log("Инициализация About завершена успешно"),y()}catch(p){return console.error("Ошибка при инициализации About:",p),null}}function X(){const t=document.getElementById("features"),n=document.getElementById("featuresVideo"),e=document.getElementById("soundToggleButton"),l=document.getElementById("volumeOffIcon"),i=document.getElementById("volumeOnIcon"),r=document.getElementById("buyButton"),c=document.getElementById("moreInfoButton");if(!t){console.warn("Features section not found");return}n&&(n.volume=.5,n.play().catch(u=>{console.log("Автовоспроизведение не удалось:",u)})),r&&r.addEventListener("click",B),c&&c.addEventListener("click",M),e&&e.addEventListener("click",()=>T(n,l,i));const m=()=>{K(t,n,l,i)};return window.addEventListener("scroll",m),function(){r&&r.removeEventListener("click",B),c&&c.removeEventListener("click",M),e&&e.removeEventListener("click",()=>T(n,l,i)),window.removeEventListener("scroll",m),console.log("Features component cleaned up")}}function T(t,n,e){if(t)if(t.muted=!t.muted,t.muted){n.style.display="block",e.style.display="none";const l=document.getElementById("soundToggleButton");l&&l.setAttribute("aria-label","Включить звук")}else{t.volume=.5,n.style.display="none",e.style.display="block";const l=document.getElementById("soundToggleButton");l&&l.setAttribute("aria-label","Выключить звук")}}function K(t,n,e,l){if(!t||!n||n.muted)return;const i=t.getBoundingClientRect();if(!(i.top<window.innerHeight&&i.bottom>0)){n.muted=!0,e.style.display="block",l.style.display="none";const c=document.getElementById("soundToggleButton");c&&c.setAttribute("aria-label","Включить звук")}}function B(){window.open("https://www.aliexpress.com/item/1005007171465465.html?spm=a2g0o.store_pc_home.0.0.70583a88IDCuNJ&pdp_npi=4%40dis%21UAH%214%C2%A0485%2C21%20%D0%B3%D1%80%D0%BD.%211%C2%A0472%2C53%20%D0%B3%D1%80%D0%BD.%21%21%21767.45%21251.96%21%40211b498b17390151033607761d21d7%2112000039694115852%21sh%21UA%211927913003%21X","_blank","noopener,noreferrer")}function M(){const t=document.getElementById("features-r36s");if(t){const n=t.getBoundingClientRect().top,e=window.scrollY||window.pageYOffset,l=n+e;window.scrollTo({top:l,behavior:"smooth"}),window.history.replaceState(null,"",`${window.location.pathname}#features-r36s`)}}function ee(){try{let o=function(){m&&(m.innerHTML=y?`<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
           ...
           </svg>`)},h=function(){if(!(!i||s))if(y)i.pause(),y=!1,o();else{const S=i.play();S!==void 0?S.then(()=>{y=!0,o()}).catch(x=>{console.warn("Не удалось воспроизвести видео:",x),y=!1,o()}):(y=!0,o())}},_=function(){w&&(s=!0,i&&(i.style.display="none"),w.innerHTML=`
...
`).forEach(h=>{s+=`<p>${h.trim()}</p>`}),s+="</div>",o.content.images&&(s+=`
          ...
          `),s+="</div></div>"}),s+="</div>"),s+="</div>",s}function y(){m.innerHTML="",l.forEach(a=>{const s=document.createElement("section");s.id=a.id,s.className=`section ${i===a.id?"section-active":""}`,s.innerHTML=`
        <h2 class="section-title">${a.title}</h2>
        ${b(a)}
      `,m.appendChild(s)})}function p(){g(),v(),y(),window.addEventListener("resize",g),console.log("Products: Инициализация завершена. Используются пути к изображениям без /public/")}return c&&m&&u?p():console.error("Не найдены необходимые DOM элементы для секции Products"),{handleSectionClick:w,checkMobile:g}}function le(){console.log("Инициализация Footer");const t=document.querySelector(".footer");if(!t){console.error("Элемент footer не найден");return}const n=t.querySelector(".partnership-button");n&&n.addEventListener("click",()=>{const e=document.querySelector(".partnership-modal-overlay");if(e){e.classList.add("active");const l=e.querySelector(".partnership-modal-content");l&&l.classList.add("active"),document.body.style.overflow="hidden"}}),ce()}function ce(){const t=document.querySelector(".partnership-modal-overlay");if(!t){console.warn("Модальное окно не найдено");return}const n=t.querySelector(".partnership-modal-close");n&&n.addEventListener("click",e),t.addEventListener("click",l=>{l.target===t&&e()}),document.addEventListener("keydown",l=>{l.key==="Escape"&&t.classList.contains("active")&&e()});function e(){const l=t.querySelector(".partnership-modal-content");t.classList.remove("active"),l&&l.classList.remove("active"),document.body.style.overflow=""}}function de(){console.log("Инициализация кнопки прокрутки вверх");const t=document.createElement("button");t.className="scroll-to-top",t.setAttribute("aria-label","Прокрутить вверх страницы"),t.innerHTML=`
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
      <polyline points="18 15 12 9 6 15"></polyline>
    </svg>
  `,document.body.appendChild(t);let n=!1;function e(r,c){let m;return function(){const u=arguments,g=this;m||(r.apply(g,u),m=!0,setTimeout(()=>m=!1,c))}}const l=e(function(){const c=(window.pageYOffset||document.documentElement.scrollTop)>300;c!==n&&(c?(t.style.visibility="visible",setTimeout(()=>{t.classList.add("visible")},10)):(t.classList.remove("visible"),setTimeout(()=>{n||(t.style.visibility="hidden")},300)),n=c)},100);function i(r){r.preventDefault(),t.classList.add("active"),setTimeout(()=>{t.classList.remove("active")},200),window.scrollTo({top:0,behavior:"smooth"})}return window.addEventListener("scroll",l,{passive:!0}),t.addEventListener("click",i),l(),function(){console.log("Очистка кнопки прокрутки вверх"),window.removeEventListener("scroll",l),t.removeEventListener("click",i),t&&t.parentNode&&t.parentNode.removeChild(t)}}console.log("Main.js инициализирован");let k=[];const q=H();typeof q=="function"&&k.push(q);const j=G();typeof j=="function"&&k.push(j);function ue(){const t="IntersectionObserver"in window,n=function(){const l=document.createElement("div");return l.style.display="flex",l.style.display==="flex"}(),e=function(){const l=document.createElement("div");return l.style.display="grid",l.style.display==="grid"}();return console.log("Поддержка браузера:"),console.log("- IntersectionObserver:",t),console.log("- Flexbox:",n),console.log("- CSS Grid:",e),t||document.body.classList.add("no-intersection-observer"),n||document.body.classList.add("no-flexbox"),e||document.body.classList.add("no-grid"),{hasIntersectionObserver:t,hasFlexbox:n,hasGrid:e}}function me(){try{k.forEach(t=>{typeof t=="function"&&t()}),k=[]}catch(t){console.warn("Error during global cleanup:",t)}}document.addEventListener("DOMContentLoaded",()=>{console.log("DOM загружен");try{ne();const t=ue(),n=z();typeof n=="function"&&k.push(n);const e=Q();typeof e=="function"&&k.push(e);const l=X();typeof l=="function"&&k.push(l);const i=ee();typeof i=="function"&&k.push(i);const r=te();typeof r=="function"&&k.push(r);const c=oe();typeof c=="function"&&k.push(c);const m=ie();typeof m=="function"&&k.push(m);const u=re();typeof u=="function"&&k.push(u);const g=ae();typeof g=="function"&&k.push(g);const w=le();typeof w=="function"&&k.push(w);const v=de();typeof v=="function"&&k.push(v);const b=performance.now();console.log(`Страница загружена за ${b.toFixed(2)}ms`),window.addEventListener("beforeunload",me)}catch(t){console.error("Ошибка при инициализации страницы:",t)}});window.onerror=function(t,n,e,l,i){return console.error("Глобальная ошибка:",{message:t,source:n,lineno:e,colno:l,error:i}),!1};window.addEventListener("unhandledrejection",function(t){console.warn("Непойманное отклонение промиса (unhandled promise rejection):",t.reason)});window.appVersion={version:"1.0.0",buildDate:new Date().toISOString(),environment:"production",basePath:"/R36S_CONSOLE_STORE_JS/"};console.log("Main.js выполнение завершено");
